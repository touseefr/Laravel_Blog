...
$(document).ready(function (event) {
    ...
    var table = $('#await').DataTable({
        ...
        order: [0, 'desc'],
        "ajax": {
            'url': baseUrl + '/user/getuserawatingblog',
            'type': 'POST',
            'data': {
        ...
        "columnDefs": [
            ...
            {
                "render": function (data, type, row, meta) {
                    return `<a href="${baseUrl}/user/editblog/${row.id}" class="btn btn-primary btn-sm edittag" ><i class='fas fa-pencil-alt'></i></a>`
                },
                "targets": 7
            },
            {
